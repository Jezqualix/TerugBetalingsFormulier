...
const COLUMNS = [
  ...
  { header: 'Reden urgentie',      key: 'reden_urgentie' },
  { header: 'Contract',            key: 'contract' },
  { header: 'Klant',               key: 'klant' },
  { header: 'Referentie boete',    key: 'referentie_boete' },
  { header: 'Vervaldatum boete',   key: 'vervaldatum_boete' },
  { header: 'Gedetailleerde omschrijving', key: 'gedetailleerde_omschrijving' },
  { header: 'Onkosten items',      key: 'onkosten_items' },
  { header: 'ProPlanner',          key: 'proplanner_aangevraagd' },
